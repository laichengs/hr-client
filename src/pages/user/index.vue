    ...
    <el-row>
      <el-col :span="20">
        <el-form-item label="籍贯地" prop="native">
          ...
          <el-input style="width:400px;" v-model="form.native"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="20">
        <el-form-item label="现居地" prop="place">
          ...
          <el-input style="width:400px;" v-model="form.place"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-form-item>
